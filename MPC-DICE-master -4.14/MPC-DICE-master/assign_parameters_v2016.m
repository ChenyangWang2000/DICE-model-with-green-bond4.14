...
Params.T_AT_max = 20; 
    ...
    % Constants
    Params.N = 80;                  % Horizon length
    Params.BaseYear = 2020;        % First calendar year*
    Params.eta = 3.6813;              % Forcings of equilibrium CO2 doubling (GAMS fco22x)[常数、无需改动]
    Params.M_AT_Base = 412.5;        % Base atm carbon concentration (GAMS in FORC(t) eqn)*
    ...
    Params.rho = 0.035;            % Initial rate of social time preference per year (GAMS prstp)*
    ...
    Params.L0 = 7821;           % Initial population*
    Params.La = 11500;          % Asymptotic population
    Params.lg = 0.05;          % Population growth rate*

    Params.EL0 = 3.5;           % Initial land use emissions*
    Params.deltaEL = 0.115;       % Land use emissions decrease rate

    Params.A0 = 2.32;            % Initial Total Factor Productivity (TFP)*
    Params.ga = 0.14;          % Initial TFP rate*
    ...
    e0 = 50.1;                 % Initial emissions*
    q0 = 133;                 % Initial global output*
    Params.miu0 = 0.05;               % Initial mitigation rate*
